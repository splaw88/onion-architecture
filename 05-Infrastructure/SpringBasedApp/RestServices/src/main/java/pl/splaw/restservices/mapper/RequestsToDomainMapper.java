package pl.splaw.onionarchitecture.restservices.mapper;

import pl.splaw.onionarchitecture.domain.model.WorkLog;
import pl.splaw.onionarchitecture.domain.model.Worker;
import pl.splaw.onionarchitecture.restservices.dto.worker.EditWorkerRequest;
import pl.splaw.onionarchitecture.restservices.dto.worker.NewWorkerRequest;
